...
_PRETEXT_VENDOR=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/../gstack/design-html/vendor/pretext.js" ] && _PRETEXT_VENDOR="$_ROOT/../gstack/design-html/vendor/pretext.js"
[ -z "$_PRETEXT_VENDOR" ] && [ -f ../gstack/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=../gstack/design-html/vendor/pretext.js
