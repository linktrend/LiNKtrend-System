...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/../gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/../gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/../gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/../gstack/extension"
