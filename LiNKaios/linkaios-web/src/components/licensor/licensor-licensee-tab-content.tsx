...
export function LicensorLicenseeTabContent(props: { tab: LicensorLicenseeTabId; licenseeId: string }) {
  ...
  switch (props.tab) {
    ...
    case "support":
      return <LicensorLicenseeSupportPanel licenseeId={props.licenseeId} />;
    case "overview":
    default:
