      ...
      <div className="mt-4 grid gap-6 md:grid-cols-2">
        <form action={createQuickNoteDraftAction} className="space-y-2">
          ...
          <label className={FORM.fieldStack}>
            <span className={`${FIELD.label} text-xs text-zinc-600 dark:text-zinc-400`}>Sensitivity</span>
            <InsetSelect compact name="sensitivity" defaultValue="internal">
