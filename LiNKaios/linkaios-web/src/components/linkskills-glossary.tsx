  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-zinc-50/80 p-4 text-xs leading-6 text-zinc-700 dark:border-zinc-800 dark:bg-zinc-900/40 dark:text-zinc-300">
      <p>
        ...
        <strong>Capability</strong> = governed bridge to external software (Odoo, Plane, Zulip, etc.).{" "}
...
export function LinkskillsGlossaryBrief(props: { kind: "skills" | "tools" | "connectors" | "leases" }) {
  const copy =
    props.kind === "skills"
      ? "Skills are packaged procedures; they call governed tools and capabilities at runtime."
      : props.kind === "tools"
        ...
        : props.kind === "leases"
          ...
          : "Capabilities are governed bridges to external software — not skills or tools themselves.";
