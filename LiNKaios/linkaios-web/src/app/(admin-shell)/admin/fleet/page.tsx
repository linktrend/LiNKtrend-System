  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-zinc-600 dark:text-zinc-400">
        Fleet v1 is the low-level runtime dashboard for OpenClaw and Agent Zero worker processes — infra health and
        gateway instances. It is separate from the LiNKbot identity registry under{" "}
        <span className="font-medium">All LiNKbots</span>, which lists every deployed bot for vendor monitoring.
      </p>
