...
import { DEMO_SIDEBAR_MISSIONS, DEMO_SIDEBAR_PROJECTS } from "./entities";

const nowIso = () => new Date().toISOString();

export type DemoProjectDetailSpec = {
  id: string;
  title: string;
  tagline: string;
...
/** @deprecated Use {@link DemoProjectDetailSpec}. */
export type DemoMissionDetailSpec = DemoProjectDetailSpec;

/** Optional Plane-style bridge fields for the projects index when mocks are on. */
export const DEMO_PROJECT_PLANE_BRIDGE: Record<
  string,
  {
    code: string;
    activeCycle: string;
...
/** @deprecated Use {@link DEMO_PROJECT_PLANE_BRIDGE}. */
export const DEMO_MISSION_PLANE_BRIDGE = DEMO_PROJECT_PLANE_BRIDGE;

export function demoProjectsFixtureRows(): ProjectRecord[] {
  return [
    ...DEMO_SIDEBAR_PROJECTS,
    {
      id: "demo-mission-1",
...
/** @deprecated Use {@link demoProjectsFixtureRows}. */
export const demoMissionsFixtureRows = demoProjectsFixtureRows;

export const DEMO_PROJECT_DETAIL_SPECS: Record<string, DemoProjectDetailSpec> = {
  "demo-smb": {
    id: "demo-smb",
...
/** @deprecated Use {@link DEMO_PROJECT_DETAIL_SPECS}. */
export const DEMO_MISSION_DETAIL_SPECS = DEMO_PROJECT_DETAIL_SPECS;
