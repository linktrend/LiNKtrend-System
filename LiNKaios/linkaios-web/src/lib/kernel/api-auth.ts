...
export type KernelAuthEnv = {
  [key: string]: string | undefined;
  BOT_KERNEL_API_SECRET?: string;
  LINKAIOS_ENABLE_MVO_SERVICE_BYPASS?: string;
  LINKAIOS_DISABLE_MVO_USER_KERNEL_API?: string;
  LINKAIOS_MVO_KERNEL_OPERATOR_USER_IDS?: string;
};
