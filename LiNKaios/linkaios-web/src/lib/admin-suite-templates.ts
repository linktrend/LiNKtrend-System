        ...
        issues: [
          {
            ...
            executors: [{ kind: "agent", name: "Suite Architect", roleId: "linksuitegen_suite_architect", description: "Draft governed variant schema for LiNKsuitegen." }],
          },
          {
            id: "sg-intake-2",
      ...
      },
      {
        ...
        issues: [
          ...
          },
          {
            ...
            executors: [{ kind: "agent", name: "Suite Validator", roleId: "linksuitegen_suite_validator", description: "Review bundle validation output before publish." }],
          },
        ],
      },
      {
        ...
        issues: [
          {
            ...
            executors: [{ kind: "agent", name: "Librarian Bot", roleId: "linkbrain_librarian", description: "Classify filing priority and scope." }],
          },
        ],
      },
      {
        ...
        issues: [
          {
            ...
            executors: [{ kind: "agent", name: "Platform Operator", roleId: "platform_operator", description: "Draft governed ops scope." }],
          },
        ],
      },
      {
