...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-212-linksites-runtime-spine.md` exactly. This is a major LinkSites runtime spine packet.
...
- Update the required `dev-swarm/reports/legacy-ai-swarm/WP-212-linksites-runtime-spine.md` before stopping.
