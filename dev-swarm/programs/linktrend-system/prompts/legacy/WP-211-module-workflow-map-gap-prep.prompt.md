...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-211-module-workflow-map-gap-prep.md` exactly. This is a bounded module workflow-map prep packet.
...
- Update the required `dev-swarm/reports/legacy-ai-swarm/WP-211-module-workflow-map-gap-prep.md` before stopping.
