...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-214-linksites-linkbot-role-execution.md` exactly. This is a LiNKbot role execution packet.
...
- Update the required `dev-swarm/reports/legacy-ai-swarm/WP-214-linksites-linkbot-role-execution.md` before stopping.
