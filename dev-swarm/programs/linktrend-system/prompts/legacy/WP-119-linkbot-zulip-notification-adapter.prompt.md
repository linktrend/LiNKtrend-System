...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-119-linkbot-zulip-notification-adapter.md`.
...
- `dev-swarm/programs/linktrend-system/issues/legacy/WP-119-linkbot-zulip-notification-adapter.md`
...
Follow the work packet proof section. Update `dev-swarm/reports/legacy-ai-swarm/WP-119-linkbot-zulip-notification-adapter.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
