...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-218-linksites-proof-runbook-and-local-preview.md` exactly. This is a LinkSites runbook/local preview packet.
...
- Read `.worktrees/WP-212-linksites-runtime-spine/dev-swarm/reports/legacy-ai-swarm/WP-212-linksites-runtime-spine.md` if present. WP-212 reported that runtime proof was blocked by workspace topology resolving to legacy `apps/linkaios-web`; the runbook must not hide this blocker.
- Read `dev-swarm/reports/legacy-ai-swarm/WP-213-linksites-linkskills-enforcement.md`, `dev-swarm/reports/legacy-ai-swarm/WP-214-linksites-linkbot-role-execution.md`, and `dev-swarm/reports/legacy-ai-swarm/WP-215-linksites-linkbrain-trace-proof.md` if present.
...
- Update the required `dev-swarm/reports/legacy-ai-swarm/WP-218-linksites-proof-runbook-and-local-preview.md` before stopping.
