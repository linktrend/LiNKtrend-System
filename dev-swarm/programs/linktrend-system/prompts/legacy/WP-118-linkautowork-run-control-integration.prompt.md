...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-118-linkautowork-run-control-integration.md`.
...
- `dev-swarm/programs/linktrend-system/issues/legacy/WP-118-linkautowork-run-control-integration.md`
...
Follow the work packet proof section. Update `dev-swarm/reports/legacy-ai-swarm/WP-118-linkautowork-run-control-integration.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
