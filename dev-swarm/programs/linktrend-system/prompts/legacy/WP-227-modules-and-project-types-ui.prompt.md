...
Execute `dev-swarm/programs/linktrend-system/issues/legacy/WP-227-modules-and-project-types-ui.md` exactly.
...
1. `dev-swarm/programs/linktrend-system/issues/legacy/WP-227-modules-and-project-types-ui.md`
...
Write `dev-swarm/reports/legacy-ai-swarm/WP-227-modules-and-project-types-ui.md` with files changed, commands run, screenshots/proof, blockers, final commit SHA, and remaining backlog items.
