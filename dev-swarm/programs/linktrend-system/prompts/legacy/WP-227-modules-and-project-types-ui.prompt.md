...
Execute `.ai-swarm/WORK_PACKETS/WP-227-modules-and-project-types-ui.md` exactly.
...
1. `.ai-swarm/WORK_PACKETS/WP-227-modules-and-project-types-ui.md`
...
Write `.ai-swarm/AGENT_REPORTS/WP-227-modules-and-project-types-ui.md` with files changed, commands run, screenshots/proof, blockers, final commit SHA, and remaining backlog items.
