...
INTENT_FILE="dev-swarm/product/grounding/INTENT.md"
SCHEMA_FILE="dev-swarm/factory/contracts/intent-verdict.schema.json"
VERDICT_REPORT="dev-swarm/product/reports/${PROGRAM_ID}/intent-verdict.json"
VERDICT_PROGRAM="dev-swarm/product/programs/${PROGRAM_ID}/intent-verdict.json"
