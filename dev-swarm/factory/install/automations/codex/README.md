...
- **Prompt:** `dev-swarm/factory/prompts/executor-codex/ROLE.md` + issue spec from `dev-swarm/factory/programs/bootstrap/issues/<id>.md`
...
Automation run must update `dev-swarm/product/reports/<id>.md` and push branch without Chairman starting Codex.
...
3. Point prompt at `dev-swarm/factory/prompts/executor-codex/ROLE.md` and issue spec under `dev-swarm/product/programs/`.
