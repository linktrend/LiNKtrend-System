...
title: Build Dev Swarm portable factory
status: complete
...
Build `dev-swarm/` inside LiNKtrend-System through Wave 4. Bootstrap mode uses one-line launchers; runtime mode after wire.

## Module: factory — Phase: all waves

| Issue | Title | Runtime | Tier | Depends on | Parallel group |
|-------|-------|---------|------|------------|----------------|
| DS-001 | Scaffold dev-swarm tree | cursor | standard | [] | A |
...
| DS-023 | GitHub dev-swarm-guard workflow | codex | standard | DS-003 | E |
...
|-------|----------------|-----------------|
| DS-003 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-004 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-014 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-015 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-022 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-023 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-031 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-034 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-041 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-042 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
| DS-045 | swarm:ready, runtime:codex | dev-swarm-codex-executor |
...
| Executor | swarm:ready + runtime:cursor | dev-swarm-executor-cursor |

## Issue index

All specs: `dev-swarm/factory/programs/bootstrap/issues/`  
All prompts: `dev-swarm/factory/programs/bootstrap/prompts/`  
One-line launchers: `dev-swarm/factory/programs/bootstrap/LAUNCHERS.md`
