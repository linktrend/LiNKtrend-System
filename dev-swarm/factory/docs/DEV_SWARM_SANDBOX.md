# Dev Swarm isolation decision (DS-B12)
...
| **Git worktrees** under `.worktrees/` | **No** — not part of Dev Swarm |
...
- LAW-05, DS-B25: `factory/laws/DEV_SWARM_LAWS.md`, `factory/BORROW-PACK.md`
