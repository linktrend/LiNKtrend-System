...
Planner copies this file to `dev-swarm/product/grounding/STACK.md` after Chairman OK on the finished-product narrative. Gates read it to decide architecture checks and smoke commands.
...
Commands Dev Swarm gates may invoke (non-zero exit fails the gate):
