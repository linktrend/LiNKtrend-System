# Dev Swarm Skills MERGE-LOG
Generated: consolidation Phase 1
...
| GS-browse | `dev-swarm/skills/gstack/browse/` | `.cursor/skills/gstack-browse/` | nested already canonical |
| GS-browser-skills-hackernews-frontpage | `dev-swarm/skills/gstack/browser-skills-hackernews-frontpage/` | `.cursor/skills/gstack-browser-skills-hackernews-frontpage/` | flat-only; copied into nested path |
| GS-canary | `dev-swarm/skills/gstack/canary/` | `.cursor/skills/gstack-canary/` | nested already canonical |
| GS-careful | `dev-swarm/skills/gstack/careful/` | `.cursor/skills/gstack-careful/` | nested already canonical |
| GS-codex | `dev-swarm/skills/gstack/codex/` | `.cursor/skills/gstack-codex/` | nested already canonical |
| GS-context-restore | `dev-swarm/skills/gstack/context-restore/` | `.cursor/skills/gstack-context-restore/` | nested already canonical |
| GS-context-save | `dev-swarm/skills/gstack/context-save/` | `.cursor/skills/gstack-context-save/` | nested already canonical |
| GS-cso | `dev-swarm/skills/gstack/cso/` | `.cursor/skills/gstack-cso/` | nested already canonical |
| GS-design-consultation | `dev-swarm/skills/gstack/design-consultation/` | `.cursor/skills/gstack-design-consultation/` | nested already canonical |
| GS-design-html | `dev-swarm/skills/gstack/design-html/` | `.cursor/skills/gstack-design-html/` | nested already canonical |
| GS-design-review | `dev-swarm/skills/gstack/design-review/` | `.cursor/skills/gstack-design-review/` | nested already canonical |
| GS-design-shotgun | `dev-swarm/skills/gstack/design-shotgun/` | `.cursor/skills/gstack-design-shotgun/` | nested already canonical |
| GS-devex-review | `dev-swarm/skills/gstack/devex-review/` | `.cursor/skills/gstack-devex-review/` | nested already canonical |
| GS-document-generate | `dev-swarm/skills/gstack/document-generate/` | `.cursor/skills/gstack-document-generate/` | nested already canonical |
| GS-document-release | `dev-swarm/skills/gstack/document-release/` | `.cursor/skills/gstack-document-release/` | nested already canonical |
| GS-freeze | `dev-swarm/skills/gstack/freeze/` | `.cursor/skills/gstack-freeze/` | nested already canonical |
| GS-gstack-upgrade | `dev-swarm/skills/gstack/gstack-upgrade/` | `.cursor/skills/gstack-gstack-upgrade/` | nested already canonical |
| GS-guard | `dev-swarm/skills/gstack/guard/` | `.cursor/skills/gstack-guard/` | nested already canonical |
| GS-health | `dev-swarm/skills/gstack/health/` | `.cursor/skills/gstack-health/` | nested already canonical |
| GS-investigate | `dev-swarm/skills/gstack/investigate/` | `.cursor/skills/gstack-investigate/` | nested already canonical |
| GS-land-and-deploy | `dev-swarm/skills/gstack/land-and-deploy/` | `.cursor/skills/gstack-land-and-deploy/` | nested already canonical |
| GS-landing-report | `dev-swarm/skills/gstack/landing-report/` | `.cursor/skills/gstack-landing-report/` | nested already canonical |
| GS-learn | `dev-swarm/skills/gstack/learn/` | `.cursor/skills/gstack-learn/` | nested already canonical |
| GS-make-pdf | `dev-swarm/skills/gstack/make-pdf/` | `.cursor/skills/gstack-make-pdf/` | nested already canonical |
| GS-office-hours | `dev-swarm/skills/gstack/office-hours/` | `.cursor/skills/gstack-office-hours/` | nested already canonical |
| GS-open-gstack-browser | `dev-swarm/skills/gstack/open-gstack-browser/` | `.cursor/skills/gstack-open-gstack-browser/` | nested already canonical |
| GS-openclaw-skills-gstack-openclaw-ceo-review | `dev-swarm/skills/gstack/openclaw-skills-gstack-openclaw-ceo-review/` | `.cursor/skills/gstack-openclaw-skills-gstack-openclaw-ceo-review/` | flat-only; copied into nested path |
| GS-openclaw-skills-gstack-openclaw-investigate | `dev-swarm/skills/gstack/openclaw-skills-gstack-openclaw-investigate/` | `.cursor/skills/gstack-openclaw-skills-gstack-openclaw-investigate/` | flat-only; copied into nested path |
| GS-openclaw-skills-gstack-openclaw-office-hours | `dev-swarm/skills/gstack/openclaw-skills-gstack-openclaw-office-hours/` | `.cursor/skills/gstack-openclaw-skills-gstack-openclaw-office-hours/` | flat-only; copied into nested path |
| GS-openclaw-skills-gstack-openclaw-retro | `dev-swarm/skills/gstack/openclaw-skills-gstack-openclaw-retro/` | `.cursor/skills/gstack-openclaw-skills-gstack-openclaw-retro/` | flat-only; copied into nested path |
| GS-pair-agent | `dev-swarm/skills/gstack/pair-agent/` | `.cursor/skills/gstack-pair-agent/` | nested already canonical |
| GS-plan-ceo-review | `dev-swarm/skills/gstack/plan-ceo-review/` | `.cursor/skills/gstack-plan-ceo-review/` | nested already canonical |
| GS-plan-design-review | `dev-swarm/skills/gstack/plan-design-review/` | `.cursor/skills/gstack-plan-design-review/` | nested already canonical |
| GS-plan-devex-review | `dev-swarm/skills/gstack/plan-devex-review/` | `.cursor/skills/gstack-plan-devex-review/` | nested already canonical |
| GS-plan-eng-review | `dev-swarm/skills/gstack/plan-eng-review/` | `.cursor/skills/gstack-plan-eng-review/` | nested already canonical |
| GS-plan-tune | `dev-swarm/skills/gstack/plan-tune/` | `.cursor/skills/gstack-plan-tune/` | nested already canonical |
| GS-qa | `dev-swarm/skills/gstack/qa/` | `.cursor/skills/gstack-qa/` | nested already canonical |
| GS-qa-only | `dev-swarm/skills/gstack/qa-only/` | `.cursor/skills/gstack-qa-only/` | nested already canonical |
| GS-retro | `dev-swarm/skills/gstack/retro/` | `.cursor/skills/gstack-retro/` | nested already canonical |
| GS-review | `dev-swarm/skills/gstack/review/` | `.cursor/skills/gstack-review/` | nested already canonical |
| GS-scrape | `dev-swarm/skills/gstack/scrape/` | `.cursor/skills/gstack-scrape/` | nested already canonical |
| GS-setup-browser-cookies | `dev-swarm/skills/gstack/setup-browser-cookies/` | `.cursor/skills/gstack-setup-browser-cookies/` | nested already canonical |
| GS-setup-deploy | `dev-swarm/skills/gstack/setup-deploy/` | `.cursor/skills/gstack-setup-deploy/` | nested already canonical |
| GS-setup-gbrain | `dev-swarm/skills/gstack/setup-gbrain/` | `.cursor/skills/gstack-setup-gbrain/` | nested already canonical |
| GS-ship | `dev-swarm/skills/gstack/ship/` | `.cursor/skills/gstack-ship/` | nested already canonical |
| GS-skillify | `dev-swarm/skills/gstack/skillify/` | `.cursor/skills/gstack-skillify/` | nested already canonical |
| GS-sync-gbrain | `dev-swarm/skills/gstack/sync-gbrain/` | `.cursor/skills/gstack-sync-gbrain/` | nested already canonical |
| GS-unfreeze | `dev-swarm/skills/gstack/unfreeze/` | `.cursor/skills/gstack-unfreeze/` | nested already canonical |
| OC-gstack-openclaw-skills-gstack-openclaw-ceo-review | `dev-swarm/skills/gstack/openclaw/skills/gstack-openclaw-ceo-review/` | `.cursor/skills/gstack-openclaw-skills-gstack-openclaw-ceo-review/` | nested openclaw skill canonical |
