...
- [ ] Workflow `.github/workflows/dev-swarm-guard.yml` enabled (validates STATE JSON on PR touching `dev-swarm/STATE.md`)
...
- [ ] `dev-swarm/scripts/verify.sh` exits 0 before merge-ready
