...
- Seeds list only stable handles / paths / policy text — confirm absence of literals in `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-114-linkskills-cross-vertical-catalog-seeds.md`.
