...
| INT-012 | LinkSites web-master template render | Preview site generation | linkaios-agent | Planned | See `DECISIONS.md` D-03 / D-07. Render `LiNKsites/apps/web-master` and serve from `LiNKaios/linkaios-web`. |
...
| INT-016 | LiNKbot (OpenClaw via LiNKbot-core) | Lead evaluation, template selection, copy gen | linkbot-agent | Planned | See `DECISIONS.md` D-04. Driven by `LiNKbot/runtime-adapters/openclaw/bot-runtime`. |
