...
**Prompt index:** `dev-swarm/product/programs/linktrend-system/prompts/legacy/PWR-*.prompt.md`  
**Launch copy-paste:** `dev-swarm/product/grounding/EXECUTE_PRE_WIRING.md`
...
**Acceptance:** `development` pushed; typecheck green; `dev-swarm/product/reports/archive/legacy-ai-swarm/PWR-W0-baseline.md` filed.
...
Integrator runs Wave 0→7 per `dev-swarm/product/grounding/EXECUTE_PRE_WIRING.md`.
...
| Wave | Report path |
|------|-------------|
| 0 | `dev-swarm/product/reports/archive/legacy-ai-swarm/PWR-W0-baseline.md` |
| 1 | `dev-swarm/product/reports/archive/legacy-ai-swarm/PWR-W1-A-*.md`, `PWR-W1-B-*.md` |
| 2 | `dev-swarm/product/reports/archive/legacy-ai-swarm/PWR-W2-*.md` |
| 3–6 | `dev-swarm/product/reports/archive/legacy-ai-swarm/PWR-W3-*.md` … `PWR-W6-*.md` |
| 7 | `dev-swarm/product/reports/archive/legacy-ai-swarm/PWR-W7-integrator-proof.md`, `PWR-FINAL.md` |
