...
| Generic rules in dev-swarm | `dev-swarm/factory/rules/` (14 files incl. `08-ui-and-frontend-standards.mdc`) |
| Product rules in .cursor only | 9 `.mdc` + `00-dev-swarm-bootstrap.mdc` |
| All agents in dev-swarm | `dev-swarm/factory/agents/` (18); `.cursor/agents/README.md` |
...
- Register Cursor + Codex automations per `dev-swarm/factory/install/automations/*/README.md`
