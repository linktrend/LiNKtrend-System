...
| `dev-swarm/skills/host/` | LiNKtrend project skills (52 SKILL.md files) |
...
| Proof | Result |
|-------|--------|
| `dev-swarm/product/grounding/` | 43 root docs from `.ai-swarm` |
...
| Proof | Result |
|-------|--------|
| `dev-swarm/factory/agents/` | architect-integrator, project-planner |
| `dev-swarm/factory/rules/` | swarm coordination, git, handoff, testing |
...
| `dev-swarm/factory/scripts/verify.sh` | Run after commit |
| `dev-swarm/factory/scripts/validate-dag.sh` | bootstrap PROGRAM DAG |
...
1. Wire session: `Execute dev-swarm/factory/install/WIRE-PROMPT.md`
