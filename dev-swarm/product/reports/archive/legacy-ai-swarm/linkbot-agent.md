...
- `dev-swarm/product/grounding/LINKAPPS_SQUAD_ORCHESTRATION_SPEC.md` (new)
- `dev-swarm/programs/linktrend-system/issues/legacy/WP-107-linkapps-squad-orchestration.md` (acceptance checkboxes)
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkbot-agent.md` (this update)
...
- `dev-swarm/product/grounding/LINKBOT_ADAPTER_PLAN.md` (new)
...
- `dev-swarm/product/grounding/LINKBOT_CORE_SYNC_READINESS.md` (new)
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkbot-agent.md` (this update)
...
- `dev-swarm/product/grounding/LINKBOT_CORE_SYNC_READINESS.md`
...
sed -n '1,360p' dev-swarm/product/grounding/LINKAIOS_KERNEL_MANIFEST.md
```
...
Wire LiNKbot reasoning dispatch for WebsiteFactory stages while keeping LiNKbot a thin runtime adapter per `dev-swarm/product/grounding/CONTRACTS_MVO.md` §6.1 and role-bleed rules §12.3.
