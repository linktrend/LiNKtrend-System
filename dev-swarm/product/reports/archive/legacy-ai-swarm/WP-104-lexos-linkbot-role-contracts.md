...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-104-lexos-linkbot-role-contracts.md` (this file)
...
- Conversion plan cites a `W3` “defense agent” without a matching `LexosRoleIdSchema` entry — documented explicitly in `dev-swarm/product/grounding/LEXOS_LINKBOT_ROLE_CONTRACTS.md` orchestration backlog.
