...
| Path |
|------|
| `dev-swarm/product/grounding/LINKAPPS_UI_PANEL_DESIGN.md` |
| `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-110-linkapps-ui-panel-design.md` |
...
- **Design:** `dev-swarm/product/grounding/LINKAPPS_UI_PANEL_DESIGN.md` — IA, panel states, manifest mapping, trace visibility.
