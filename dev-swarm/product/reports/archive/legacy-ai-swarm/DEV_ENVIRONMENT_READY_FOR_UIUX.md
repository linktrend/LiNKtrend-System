...
## Scope
Fix local dev-readiness blockers from `dev-swarm/product/reports/archive/legacy-ai-swarm/DEV_ENVIRONMENT_PROOF.md` for browser UI/UX validation with local authenticated/bypass access, without production side effects.
