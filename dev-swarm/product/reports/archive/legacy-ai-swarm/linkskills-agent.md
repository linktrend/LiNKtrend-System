...
- `dev-swarm/product/grounding/LINKSKILLS_COMPLETION_PLAN.md`
...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkskills-agent.md`
...
- `dev-swarm/product/grounding/PLUGIN_ARCHITECTURE_V2.md` — capability plugin governance model includes Postiz as a connector class.
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` — canonical capability contract pack section for modes, leases, idempotency, and failure mapping.
- `dev-swarm/product/grounding/INTEGRATION_QUEUE.md` — canonical v2 integration tracking surface.
...
- `dev-swarm/product/grounding/REPO_GIT_POLICY_ROLLOUT.md` — existing external repo reference `link-postiz-app` noted for future upstream alignment.
...
ls -la dev-swarm/product/grounding/AGENT_PROMPTS
...
sed -n '1,260p' dev-swarm/product/grounding/PLUGIN_ARCHITECTURE_V2.md
...
sed -n '1,260p' dev-swarm/product/grounding/INTEGRATION_QUEUE.md
...
1. `dev-swarm/product/grounding/LINKSKILLS_COMPLETION_PLAN.md` (new)
...
sed -n '1,260p' dev-swarm/product/grounding/LINKSKILLS_COMPLETION_PLAN.md
sed -n '1,260p' dev-swarm/product/grounding/CONTRACTS_MVO.md
...
- `dev-swarm/product/grounding/LINKAPPS_CAPABILITY_REQUIREMENTS.md` *(new)* — master matrix, canonical contract-pack table rows, §4–§8 governance sections.
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkskills-agent.md` *(this appendix)*.
...
git add dev-swarm/product/grounding/LINKAPPS_CAPABILITY_REQUIREMENTS.md dev-swarm/product/reports/archive/legacy-ai-swarm/linkskills-agent.md
...
- **Context used:** `dev-swarm/product/grounding/LINKAPPS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` §5, `dev-swarm/product/grounding/PLUGIN_ARCHITECTURE_V2.md`, `dev-swarm/product/grounding/CONTRACTS_MVO.md` §0.A.5.1 + §5.4, `/Users/linktrend/Projects/LiNKapps/scripts/create-app-repo.sh`, `/Users/linktrend/Projects/LiNKapps/scripts/release-readiness.sh`, `plugins/vertical/linkapps/manifest.yaml`.

## Final Branch and Commit

- Branch: `dev/cursor/WP-108-linkapps-capability-requirements`
- Commit SHA(s): **`4947c71`** introduces `LINKAPPS_CAPABILITY_REQUIREMENTS.md`; subsequent commits on this branch append only `dev-swarm/product/reports/archive/legacy-ai-swarm/linkskills-agent.md` WP-108 proof text (consult `git log` on branch for HEAD).
