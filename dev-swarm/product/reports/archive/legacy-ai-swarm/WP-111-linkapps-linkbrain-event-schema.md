...
- `dev-swarm/product/grounding/LINKAPPS_LINKBRAIN_EVENT_SCHEMA.md` (new)
- `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-111-linkapps-linkbrain-event-schema.md` (this file)
