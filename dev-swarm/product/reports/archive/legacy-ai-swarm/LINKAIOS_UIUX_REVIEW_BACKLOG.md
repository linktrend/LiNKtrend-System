...
Agent reports: `dev-swarm/product/reports/archive/legacy-ai-swarm/wp-wave1-*.md`, `wp-wave2-*.md`
...
**Remaining:** see `dev-swarm/product/grounding/TODO-WAVE3-REMAINING.md`
