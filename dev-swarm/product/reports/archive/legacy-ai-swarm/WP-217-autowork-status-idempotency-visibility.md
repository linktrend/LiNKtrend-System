...
- `dev-swarm/product/grounding/LINKAUTOWORK_COMPLETION_PLAN.md`
- Carry-forward reports:
  - `.worktrees/WP-210-baseline-fix-and-build-gate/dev-swarm/product/reports/archive/legacy-ai-swarm/WP-210-baseline-fix-and-build-gate.md`
  ...
  - `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-213-linksites-linkskills-enforcement.md`
