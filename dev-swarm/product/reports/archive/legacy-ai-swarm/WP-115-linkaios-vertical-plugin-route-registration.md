...
1. `dev-swarm/product/grounding/docs/vertical-plugin-route-contract.md`
...
2. `dev-swarm/product/grounding/docs/kernel-vertical-route-extension.md`
...
3. `dev-swarm/product/grounding/docs/vertical-plugin-navigation-spec.md`
...
4. `dev-swarm/product/grounding/docs/vertical-plugin-route-examples.md`
