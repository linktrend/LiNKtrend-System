...
- The checkout contained extensive unrelated modified, deleted, and untracked files across `dev-swarm/product/grounding/`, `.cursor/`, runtime packages, and top-level moved directories.
