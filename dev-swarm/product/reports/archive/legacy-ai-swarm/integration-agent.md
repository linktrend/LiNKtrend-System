...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md`
...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md` (this entry)
...
- `dev-swarm/product/grounding/INTEGRATION_QUEUE.md` — added v2 section and "out of scope" list; marked v1 stubbed-integrations section as historical.
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md` — this entry.
...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/security-auditor.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md`
...
- `dev-swarm/product/grounding/MERGE_QUEUE.md`
- `git status --short`
- `git diff --stat`
...
- `dev-swarm/product/grounding/AGENT_COORDINATION.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkaios-agent.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkautowork-agent.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/security-auditor.md`
...
- `dev-swarm/product/grounding/INTEGRATION_QUEUE.md`
- `dev-swarm/product/grounding/LINKAIOS_KERNEL_MANIFEST.md`
- `dev-swarm/product/grounding/MERGE_QUEUE.md`
...
1. `dev-swarm/product/grounding/**` docs/roadmap files should not be mixed into runtime auth/kernel changes because they add high review noise and hide security-critical deltas.
...
git diff --stat
git diff --name-only
rg -n "6f7e0389-886e-4c27-b61d-6cbb5fd53269" dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md dev-swarm/product/grounding/AGENT_COORDINATION.md dev-swarm/product/grounding/MERGE_QUEUE.md scripts/run-e2e.ts
...
sed -n '1,260p' dev-swarm/product/grounding/CONTRACTS_MVO.md
sed -n '500,760p' dev-swarm/product/grounding/CONTRACTS_MVO.md
sed -n '1,260p' dev-swarm/product/grounding/DEMO_RUNBOOK_WEBSITEFACTORY_MVO.md
...
- Recommend **split into two PRs**:
  ...
  2. Swarm/report/roadmap docs (`dev-swarm/product/grounding/**`)
...
#### Commands Run
```bash
cat dev-swarm/product/grounding/AGENT_COORDINATION.md
cat dev-swarm/product/grounding/MERGE_QUEUE.md
cat dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md
cat dev-swarm/product/reports/archive/legacy-ai-swarm/security-auditor.md
git status --short
git diff --stat
git diff -- .env.example
rg -n "(BLOCKER|blocked|superseded|TBD)" dev-swarm/product/grounding/AGENT_COORDINATION.md dev-swarm/product/grounding/MERGE_QUEUE.md dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md dev-swarm/product/reports/archive/legacy-ai-swarm/security-auditor.md
pnpm --filter @linktrend/linkaios-web test -- src/lib/kernel/api-auth.test.ts src/lib/kernel/kernel.test.ts
```
...
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` §11 — Stub behaviors specification
- `dev-swarm/product/grounding/DECISIONS.md` D-01, D-02, D-03 — CRM, Plane, preview publishing decisions
- `dev-swarm/product/grounding/INTEGRATION_QUEUE.md` INT-020, INT-021, INT-022 — Stub integration items
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkskills-agent.md` — WP-007 completion report
- `dev-swarm/product/reports/archive/legacy-ai-swarm/linkautowork-agent.md` — WP-008 completion report
...
| File | Action | Purpose |
|------|--------|---------|
| `dev-swarm/product/grounding/LINKAPPS_VERTICAL_DISCOVERY.md` | Created | Discovery document with starter kit assets, workflow, and gaps |
| `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md` | Created | This agent report |
...
- `dev-swarm/product/grounding/AGENT_COORDINATION.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md`
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` (§§8-10, §12)
- `dev-swarm/product/grounding/DECISIONS.md`
...
```text
 dev-swarm/product/grounding/AGENT_COORDINATION.md                  |  8 +--
 dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md     | 68 +++++++++++++++++++++++-
...
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` §§8-10
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md`
- `LiNKaios/linkaios-web/src/lib/kernel/orchestrator.ts`
- `LiNKaios/linkaios-web/src/lib/kernel/dispatch.ts`
- `scripts/run-e2e.ts`
...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md` (WP-029/WP context)
- `dev-swarm/programs/linktrend-system/issues/legacy/WP-016-real-plane-integration-cutover.md`
- `services/migrations/024_linkskills_capability_lease.sql`
- `LiNKaios/linkaios-web/src/lib/kernel/dispatch.ts`
...
```bash
sed -n '1,240p' dev-swarm/product/reports/archive/legacy-ai-swarm/integration-agent.md
...
- Added `dev-swarm/product/grounding/LINKSITES_TEMPLATE_PAYLOAD_DISCOVERY.md` with:
...
Create `dev-swarm/product/grounding/LEXOS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` and follow-up packets for converting LEXOS into a LiNKaios vertical plugin without moving code yet.

### Files Changed

- `dev-swarm/product/grounding/LEXOS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` (new)
...
- Only planning documents created in `dev-swarm/product/grounding/` and `dev-swarm/programs/linktrend-system/issues/legacy/`
...
Create `dev-swarm/product/grounding/LINKAPPS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` and follow-up packets for converting LiNKapps into the App Factory vertical plugin without moving code yet.

### Files Changed

- `dev-swarm/product/grounding/LINKAPPS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` (new)
...
- `dev-swarm/product/grounding/DECISIONS.md` - Added D-094-A documenting completion
