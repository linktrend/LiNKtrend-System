...
| `dev-swarm/product/grounding/LINKSKILLS_CROSS_VERTICAL_CAPABILITY_CATALOG.md` |
| `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-114-linkskills-cross-vertical-catalog-seeds.md` |
...
1. **Capability inventory / table:** `dev-swarm/product/grounding/LINKSKILLS_CROSS_VERTICAL_CAPABILITY_CATALOG.md` §§1–2 (ID-by-source matrices + deduped union count).
