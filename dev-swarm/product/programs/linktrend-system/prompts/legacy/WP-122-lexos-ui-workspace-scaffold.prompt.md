# WP Agent Prompt - LEXOS UI Workspace Scaffold

Use Cursor Kimi for this packet. Do not use any other model.

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-122-lexos-ui-workspace-scaffold.md`.
...
git worktree add ../LiNKtrend-System-WP -b dev/cursor/WP-122-lexos-ui-workspace-scaffold origin/development
...
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-122-lexos-ui-workspace-scaffold.md`
...
Follow the work packet proof section. Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-122-lexos-ui-workspace-scaffold.md` with files changed, commands run, proof, blockers, branch, and commit SHA.

## Finish

Commit only this packet's files and push branch `dev/cursor/WP-122-lexos-ui-workspace-scaffold` to GitHub.
