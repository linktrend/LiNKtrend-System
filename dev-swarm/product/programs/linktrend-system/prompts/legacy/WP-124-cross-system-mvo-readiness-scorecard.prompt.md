# WP Agent Prompt - Cross-System MVO Readiness Scorecard

Use Cursor Composer for this packet. Do not use any other model.

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-124-cross-system-mvo-readiness-scorecard.md`.
...
git worktree add ../LiNKtrend-System-WP -b dev/cursor/WP-124-cross-system-mvo-readiness-scorecard origin/development
...
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-124-cross-system-mvo-readiness-scorecard.md`
...
Follow the work packet proof section. Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-124-cross-system-mvo-readiness-scorecard.md` with files changed, commands run, proof, blockers, branch, and commit SHA.

## Finish

Commit only this packet's files and push branch `dev/cursor/WP-124-cross-system-mvo-readiness-scorecard` to GitHub.
