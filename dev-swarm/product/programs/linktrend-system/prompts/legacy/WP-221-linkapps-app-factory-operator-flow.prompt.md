...
Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-221-linkapps-app-factory-operator-flow.md` exactly. This is a LiNKapps operator-flow completion packet.
...
- Read `.worktrees/WP-218-linksites-proof-runbook-and-local-preview/dev-swarm/product/reports/archive/legacy-ai-swarm/WP-218-linksites-proof-runbook-and-local-preview.md` if present for proof/runbook carry-forward expectations.
...
- Update the required `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-221-linkapps-app-factory-operator-flow.md` before stopping.
