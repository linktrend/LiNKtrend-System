...
Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-228-projects-plane-ui-semantics.md` exactly.
...
1. `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-228-projects-plane-ui-semantics.md`
...
Write `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-228-projects-plane-ui-semantics.md` with files changed, commands run, screenshots/proof, blockers, final commit SHA, and backlog items.
