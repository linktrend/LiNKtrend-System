...
Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-231-linkskills-terminology-governance-ui.md` exactly.
...
1. `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-231-linkskills-terminology-governance-ui.md`
...
5. `dev-swarm/product/grounding/CONTRACTS_MVO.md` LinkSkills sections
...
Write `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-231-linkskills-terminology-governance-ui.md` with files changed, commands run, screenshots/proof, blockers, final commit SHA, and backlog items.
