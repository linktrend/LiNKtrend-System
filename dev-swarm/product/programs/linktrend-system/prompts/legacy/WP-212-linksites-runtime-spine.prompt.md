# WP-212-linksites-runtime-spine Prompt

Model: Codex

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-212-linksites-runtime-spine.md` exactly. This is a major LinkSites runtime spine packet.
...
- If `modules/linksites/workflow.md` is missing in your checkout, copy it from `.worktrees/WP-211-module-workflow-map-gap-prep/modules/linksites/workflow.md` before implementing runtime behavior.
...
- Update the required `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-212-linksites-runtime-spine.md` before stopping.
