# WP Agent Prompt - LinkSkills Lease Ledger Test Pack

Use Cursor Kimi for this packet. Do not use any other model.

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-125-linkskills-lease-ledger-test-pack.md`.
...
git worktree add ../LiNKtrend-System-WP -b dev/cursor/WP-125-linkskills-lease-ledger-test-pack origin/development
...
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-125-linkskills-lease-ledger-test-pack.md`
...
Follow the work packet proof section. Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-125-linkskills-lease-ledger-test-pack.md` with files changed, commands run, proof, blockers, branch, and commit SHA.

## Finish

Commit only this packet's files and push branch `dev/cursor/WP-125-linkskills-lease-ledger-test-pack` to GitHub.
