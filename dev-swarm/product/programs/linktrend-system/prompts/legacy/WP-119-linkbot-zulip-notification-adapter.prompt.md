# WP Agent Prompt - LinkBot Zulip Notification Adapter

Use Cursor Kimi for this packet. Do not use any other model.

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-119-linkbot-zulip-notification-adapter.md`.
...
git worktree add ../LiNKtrend-System-WP -b dev/cursor/WP-119-linkbot-zulip-notification-adapter origin/development
...
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-119-linkbot-zulip-notification-adapter.md`
...
Follow the work packet proof section. Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-119-linkbot-zulip-notification-adapter.md` with files changed, commands run, proof, blockers, branch, and commit SHA.

## Finish

Commit only this packet's files and push branch `dev/cursor/WP-119-linkbot-zulip-notification-adapter` to GitHub.
