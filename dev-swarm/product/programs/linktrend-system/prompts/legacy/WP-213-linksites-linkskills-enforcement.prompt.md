...
Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-213-linksites-linkskills-enforcement.md` exactly. This is a LinkSkills runtime enforcement packet.
...
- Update the required `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-213-linksites-linkskills-enforcement.md` before stopping.
