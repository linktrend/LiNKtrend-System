# WP Agent Prompt - LinkBot Role Pack Validation

Use Cursor Composer for this packet. Do not use any other model.

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-126-linkbot-role-pack-validation.md`.
...
git worktree add ../LiNKtrend-System-WP -b dev/cursor/WP-126-linkbot-role-pack-validation origin/development
...
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-126-linkbot-role-pack-validation.md`
...
Follow the work packet proof section. Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-126-linkbot-role-pack-validation.md` with files changed, commands run, proof, blockers, branch, and commit SHA.

## Finish

Commit only this packet's files and push branch `dev/cursor/WP-126-linkbot-role-pack-validation` to GitHub.
