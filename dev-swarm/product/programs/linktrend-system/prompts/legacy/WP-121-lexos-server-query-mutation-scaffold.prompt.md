# WP Agent Prompt - LEXOS Server Query and Mutation Scaffold

Use Cursor Kimi for this packet. Do not use any other model.

Execute `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-121-lexos-server-query-mutation-scaffold.md`.
...
git worktree add ../LiNKtrend-System-WP -b dev/cursor/WP-121-lexos-server-query-mutation-scaffold origin/development
...
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-121-lexos-server-query-mutation-scaffold.md`
...
Follow the work packet proof section. Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-121-lexos-server-query-mutation-scaffold.md` with files changed, commands run, proof, blockers, branch, and commit SHA.

## Finish

Commit only this packet's files and push branch `dev/cursor/WP-121-lexos-server-query-mutation-scaffold` to GitHub.
