...
- `dev-swarm/product/grounding/MVO_READINESS_SCORECARD.md`
- `dev-swarm/product/grounding/MVO_READINESS_SCORECARD.json`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-124-cross-system-mvo-readiness-scorecard.md`
...
- `dev-swarm/product/reports/archive/legacy-ai-swarm/*.md`
- `dev-swarm/product/programs/linktrend-system/issues/legacy/WP-090*.md` through `WP-123*.md` as present
- `dev-swarm/product/grounding/END_OF_DAY_VERIFICATION_QUEUE.md`
