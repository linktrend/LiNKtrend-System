...
- `.worktrees/WP-216-linkaios-cockpit-proof-surface/dev-swarm/product/reports/archive/legacy-ai-swarm/WP-216-linkaios-cockpit-proof-surface.md` if present
- `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-217-autowork-status-idempotency-visibility.md` if present
- `.worktrees/WP-218-linksites-proof-runbook-and-local-preview/dev-swarm/product/reports/archive/legacy-ai-swarm/WP-218-linksites-proof-runbook-and-local-preview.md` if present
...
## Report File
Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-219-lexos-linkapps-runtime-pattern-integration.md`.
