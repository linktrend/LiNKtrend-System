...
- `dev-swarm/product/grounding/LEXOS_SERVER_QUERY_MUTATION_SCAFFOLD.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-121-lexos-server-query-mutation-scaffold.md`
...
- `dev-swarm/product/grounding/LEXOS_VERTICAL_PLUGIN_CONVERSION_PLAN.md`
