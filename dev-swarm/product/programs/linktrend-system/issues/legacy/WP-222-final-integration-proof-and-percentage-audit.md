...
- `dev-swarm/product/grounding/*COMPLETION*`, `dev-swarm/product/grounding/*PROOF*`, `dev-swarm/product/grounding/*RUNBOOK*`
...
- Worktree reports that may not exist in the main checkout:
  ...
  - `.worktrees/WP-215-linksites-linkbrain-trace-proof/dev-swarm/product/reports/archive/legacy-ai-swarm/WP-215-linksites-linkbrain-trace-proof.md`
...
## Report File
Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-222-final-integration-proof-and-percentage-audit.md`.
