...
- `dev-swarm/product/grounding/LINKBOT_ZULIP_NOTIFICATION_ADAPTER.md`
- `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-119-linkbot-zulip-notification-adapter.md`
...
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` capability sections for Zulip
