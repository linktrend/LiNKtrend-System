...
## Allowed Files
- `modules/**`
- Module reference docs in `dev-swarm/product/grounding/` if needed
...
## Report File
Update `dev-swarm/product/reports/archive/legacy-ai-swarm/WP-211-module-workflow-map-gap-prep.md`.
