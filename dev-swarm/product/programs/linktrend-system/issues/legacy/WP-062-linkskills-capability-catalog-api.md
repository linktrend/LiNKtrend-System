...
- `dev-swarm/product/grounding/LINKSKILLS_COMPLETION_PLAN.md` §4.1
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` §1.2 (CapabilityPluginSurface)
- `dev-swarm/product/grounding/CONTRACTS_MVO.md` §0.A.5 (v1 capability contracts)
