...
Execute `.ai-swarm/WORK_PACKETS/WP-212-linksites-runtime-spine.md` exactly. This is a major LinkSites runtime spine packet.
...
- Update the required `.ai-swarm/AGENT_REPORTS/WP-212-linksites-runtime-spine.md` before stopping.
