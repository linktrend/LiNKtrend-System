...
Execute `.ai-swarm/WORK_PACKETS/WP-120-linksites-local-proof-runbook-and-preflight.md`.
...
- `.ai-swarm/WORK_PACKETS/WP-120-linksites-local-proof-runbook-and-preflight.md`
...
Follow the work packet proof section. Update `.ai-swarm/AGENT_REPORTS/WP-120-linksites-local-proof-runbook-and-preflight.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
