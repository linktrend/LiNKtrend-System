...
Restructure LiNKaios settings navigation and pages per Chairman decisions: merge Access into User, rename API Keys → Integrations, add Privacy & data mock GDPR flow, rename Advanced → Platform with gateway under hub.
