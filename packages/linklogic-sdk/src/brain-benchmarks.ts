 ...
 * Specification: `dev-swarm/product/grounding/LINKBRAIN_BENCHMARKING_SPEC.md`
 *
 ...
 * Keep this list aligned with `dev-swarm/product/grounding/LINKBRAIN_BENCHMARKING_SPEC.md` §5.
 */
