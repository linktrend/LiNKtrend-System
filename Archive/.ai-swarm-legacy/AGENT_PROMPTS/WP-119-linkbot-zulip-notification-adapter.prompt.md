...
Execute `.ai-swarm/WORK_PACKETS/WP-119-linkbot-zulip-notification-adapter.md`.
...
- `.ai-swarm/WORK_PACKETS/WP-119-linkbot-zulip-notification-adapter.md`
...
Follow the work packet proof section. Update `.ai-swarm/AGENT_REPORTS/WP-119-linkbot-zulip-notification-adapter.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
