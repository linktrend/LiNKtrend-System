...
| Path |
|------|
| `LiNKdev/product/grounding/LINKAPPS_UI_PANEL_DESIGN.md` |
| `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-110-linkapps-ui-panel-design.md` |
...
- **Design:** `LiNKdev/product/grounding/LINKAPPS_UI_PANEL_DESIGN.md` — IA, panel states, manifest mapping, trace visibility.
