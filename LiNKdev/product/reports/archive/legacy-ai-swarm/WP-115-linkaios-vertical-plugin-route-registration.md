...
1. `LiNKdev/product/grounding/docs/vertical-plugin-route-contract.md`
...
2. `LiNKdev/product/grounding/docs/kernel-vertical-route-extension.md`
...
3. `LiNKdev/product/grounding/docs/vertical-plugin-navigation-spec.md`
...
4. `LiNKdev/product/grounding/docs/vertical-plugin-route-examples.md`
