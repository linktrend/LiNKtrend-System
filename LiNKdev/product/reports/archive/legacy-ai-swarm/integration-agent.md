...
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md` (this entry)
...
- `LiNKdev/product/grounding/INTEGRATION_QUEUE.md` — added v2 section and "out of scope" list; marked v1 stubbed-integrations section as historical.
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md` — this entry.
...
- `LiNKdev/product/reports/archive/legacy-ai-swarm/security-auditor.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md`
...
- `LiNKdev/product/grounding/MERGE_QUEUE.md`
- `git status --short`
- `git diff --stat`
...
- `LiNKdev/product/grounding/AGENT_COORDINATION.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/linkaios-agent.md`
...
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-003-websitefactory-plugin-manifest.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-007-linkskills-lease-lifecycle.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-008-linkautowork-websitefactory-workflows.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-010-linkaios-kernel-orchestration.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-011-websitefactory-plugin-glue.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-012-mvo-stub-backends.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-013-e2e-demo-and-audit-harness.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-015-real-crm-integration-cutover.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-016-real-plane-integration-cutover.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-017-preview-publishing-upgrade-digitalocean-payload.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-018-model-routing-gateway-litellm.md`
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-019-lexos-post-mvo-integration-plan.md`

### Files that should not be in the same PR

1. `LiNKdev/product/grounding/**` docs/roadmap files should not be mixed into runtime auth/kernel changes because they add high review noise and hide security-critical deltas.
...
git diff --stat
git diff --name-only
rg -n "6f7e0389-886e-4c27-b61d-6cbb5fd53269" LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md LiNKdev/product/grounding/AGENT_COORDINATION.md LiNKdev/product/grounding/MERGE_QUEUE.md scripts/run-e2e.ts
...
2. Stage and open PR-B (`LiNKdev/` docs/reports/roadmap) second.
...
rg -n "WP-017|preview_artifact_ref|preview_url|DigitalOcean|Payload|LinkSites|preview" \
  ...
  LiNKaios/linkaios-web/src/lib/kernel/dispatch.ts \
  scripts/run-e2e.ts
sed -n '1,240p' LiNKdev/programs/linktrend-system/issues/legacy/WP-017-preview-publishing-upgrade-digitalocean-payload.md
sed -n '1,260p' LiNKdev/product/grounding/CONTRACTS_MVO.md
sed -n '500,760p' LiNKdev/product/grounding/CONTRACTS_MVO.md
sed -n '1,260p' LiNKdev/product/grounding/DEMO_RUNBOOK_WEBSITEFACTORY_MVO.md
...
- Recommend **split into two PRs**:
  ...
  2. Swarm/report/roadmap docs (`LiNKdev/product/grounding/**`)
...
- Recommend splitting runtime/test changes from `LiNKdev/` documentation changes for review clarity.
...
#### Commands Run
```bash
cat LiNKdev/product/grounding/AGENT_COORDINATION.md
cat LiNKdev/product/grounding/MERGE_QUEUE.md
cat LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md
cat LiNKdev/product/reports/archive/legacy-ai-swarm/security-auditor.md
git status --short
git diff --stat
git diff -- .env.example
rg -n "(BLOCKER|blocked|superseded|TBD)" LiNKdev/product/grounding/AGENT_COORDINATION.md LiNKdev/product/grounding/MERGE_QUEUE.md LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md LiNKdev/product/reports/archive/legacy-ai-swarm/security-auditor.md
pnpm --filter @linktrend/linkaios-web test -- src/lib/kernel/api-auth.test.ts src/lib/kernel/kernel.test.ts
```
...
#### Risks
- Single combined PR will have high review noise due to large `LiNKdev/` doc churn.
...
#### Next Steps
1. Split changes into `runtime+tests` and `LiNKdev docs` PRs.
...
- `LiNKdev/product/grounding/CONTRACTS_MVO.md` §11 — Stub behaviors specification
- `LiNKdev/product/grounding/DECISIONS.md` D-01, D-02, D-03 — CRM, Plane, preview publishing decisions
- `LiNKdev/product/grounding/INTEGRATION_QUEUE.md` INT-020, INT-021, INT-022 — Stub integration items
- `LiNKdev/product/reports/archive/legacy-ai-swarm/linkskills-agent.md` — WP-007 completion report
- `LiNKdev/product/reports/archive/legacy-ai-swarm/linkautowork-agent.md` — WP-008 completion report
...
| File | Action | Purpose |
|------|--------|---------|
| `LiNKdev/product/grounding/LINKAPPS_VERTICAL_DISCOVERY.md` | Created | Discovery document with starter kit assets, workflow, and gaps |
| `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md` | Created | This agent report |
...
- `LiNKdev/product/grounding/AGENT_COORDINATION.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md`
- `LiNKdev/product/grounding/CONTRACTS_MVO.md` (§§8-10, §12)
- `LiNKdev/product/grounding/DECISIONS.md`
...
```text
 LiNKdev/product/grounding/AGENT_COORDINATION.md                  |  8 +--
 LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md     | 68 +++++++++++++++++++++++-
...
- `LiNKdev/product/grounding/CONTRACTS_MVO.md` §§8-10
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md`
- `LiNKaios/linkaios-web/src/lib/kernel/orchestrator.ts`
- `LiNKaios/linkaios-web/src/lib/kernel/dispatch.ts`
- `scripts/run-e2e.ts`
...
- `LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md` (WP-029/WP context)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-016-real-plane-integration-cutover.md`
- `services/migrations/024_linkskills_capability_lease.sql`
- `LiNKaios/linkaios-web/src/lib/kernel/dispatch.ts`
...
```bash
sed -n '1,240p' LiNKdev/product/reports/archive/legacy-ai-swarm/integration-agent.md
sed -n '1,260p' LiNKdev/programs/linktrend-system/issues/legacy/WP-016-real-plane-integration-cutover.md
...
- Added `LiNKdev/product/grounding/LINKSITES_TEMPLATE_PAYLOAD_DISCOVERY.md` with:
...
Create `LiNKdev/product/grounding/LEXOS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` and follow-up packets for converting LEXOS into a LiNKaios vertical plugin without moving code yet.

### Files Changed

- `LiNKdev/product/grounding/LEXOS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-094-lexos-schema-core.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-097-lexos-types-generation.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-103-lexos-capability-manifests.md` (new)
...
- Only planning documents created in `LiNKdev/product/grounding/` and `LiNKdev/programs/linktrend-system/issues/legacy/`
...
Create `LiNKdev/product/grounding/LINKAPPS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` and follow-up packets for converting LiNKapps into the App Factory vertical plugin without moving code yet.

### Files Changed

- `LiNKdev/product/grounding/LINKAPPS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-106-linkapps-plugin-manifest.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-107-linkapps-squad-orchestration.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-108-linkapps-capability-requirements.md` (new)
...
- `LiNKdev/product/grounding/DECISIONS.md` - Added D-094-A documenting completion
