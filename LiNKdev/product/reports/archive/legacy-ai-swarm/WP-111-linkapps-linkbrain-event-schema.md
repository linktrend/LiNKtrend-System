...
- `LiNKdev/product/grounding/LINKAPPS_LINKBRAIN_EVENT_SCHEMA.md` (new)
- `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-111-linkapps-linkbrain-event-schema.md` (this file)
