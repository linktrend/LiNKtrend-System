...
- `LiNKdev/product/grounding/LINKAPPS_CAPABILITY_PLUGIN_CONTRACTS.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-112-linkapps-capability-plugin-contracts.md`
...
- **Primary deliverable commit:** `c012de9` — manifests + `LiNKdev/product/grounding/LINKAPPS_CAPABILITY_PLUGIN_CONTRACTS.md` + agent report (`docs: add LiNKapps capability contracts`)
