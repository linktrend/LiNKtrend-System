...
3. Prompt references `WP-226` report path that does not exist in this snapshot (`LiNKdev/product/reports/archive/legacy-ai-swarm/WP-226-linkaios-product-model-ui-foundation.md` not found).
