...
- `LiNKdev/product/grounding/LINKAPPS_SQUAD_ORCHESTRATION_SPEC.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-107-linkapps-squad-orchestration.md` (acceptance checkboxes)
- `LiNKdev/product/reports/archive/legacy-ai-swarm/linkbot-agent.md` (this update)
...
- **Commit SHA:** `e3bce4bd35a3b0883902444623330264db583092` (packet doc commit on `dev/cursor/WP-107-linkapps-squad-orchestration`; branch may include follow-up commit(s))
...
sed -n '1,240p' LiNKdev/programs/linktrend-system/prompts/legacy/WP-064-linkskills-lease-projection-and-bot-runtime-adapter.prompt.md
sed -n '1,260p' LiNKdev/programs/linktrend-system/issues/legacy/WP-064-linkskills-lease-projection-and-bot-runtime-adapter.md
...
- `LiNKdev/product/grounding/LINKBOT_ADAPTER_PLAN.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-063-linkaios-ingress-fail-closed-governance-adapter.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-064-linkskills-lease-projection-and-bot-runtime-adapter.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-065-linkbrain-audit-envelope-mapping-for-linkbot-flow.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-066-linkautowork-deterministic-handoff-orchestration.md` (new)
- `LiNKdev/programs/linktrend-system/issues/legacy/WP-067-zulip-run-messaging-governance-adapter.md` (new)
- `LiNKdev/product/reports/archive/legacy-ai-swarm/linkbot-agent.md` (this update)
...
- `LiNKdev/product/grounding/LINKBOT_CORE_SYNC_READINESS.md` (new)
- `LiNKdev/product/reports/archive/legacy-ai-swarm/linkbot-agent.md` (this update)
...
- `LiNKdev/product/grounding/LINKBOT_CORE_SYNC_READINESS.md`
...
sed -n '1,320p' LiNKdev/programs/linktrend-system/issues/legacy/WP-044-linkbot-role-contract-pack-v1.md
sed -n '1,360p' LiNKdev/product/grounding/CONTRACTS_MVO.md
sed -n '1,360p' LiNKdev/product/grounding/LINKAIOS_KERNEL_MANIFEST.md
```
...
Wire LiNKbot reasoning dispatch for WebsiteFactory stages while keeping LiNKbot a thin runtime adapter per `LiNKdev/product/grounding/CONTRACTS_MVO.md` §6.1 and role-bleed rules §12.3.
