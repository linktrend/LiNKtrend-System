...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-120-linksites-local-proof-runbook-and-preflight.md`.
...
- `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-120-linksites-local-proof-runbook-and-preflight.md`
...
Follow the work packet proof section. Update `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-120-linksites-local-proof-runbook-and-preflight.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
