...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-119-linkbot-zulip-notification-adapter.md`.
...
- `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-119-linkbot-zulip-notification-adapter.md`
...
Follow the work packet proof section. Update `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-119-linkbot-zulip-notification-adapter.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
