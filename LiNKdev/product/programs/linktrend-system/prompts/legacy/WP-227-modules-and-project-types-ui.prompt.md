...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-227-modules-and-project-types-ui.md` exactly.
...
1. `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-227-modules-and-project-types-ui.md`
...
Write `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-227-modules-and-project-types-ui.md` with files changed, commands run, screenshots/proof, blockers, final commit SHA, and remaining backlog items.
