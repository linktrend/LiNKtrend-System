...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-226-linkaios-product-model-ui-foundation.md` exactly.
...
1. `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-226-linkaios-product-model-ui-foundation.md`
2. `LiNKdev/product/reports/archive/legacy-ai-swarm/CURRENT_STATE_VERIFICATION_WARNING.md`
...
7. `LiNKdev/product/grounding/ARCHITECTURE_RULES.md`
8. `LiNKdev/product/grounding/CONTRACTS_MVO.md`
9. `LiNKdev/product/grounding/REPO_INVENTORY.md`
10. `LiNKdev/product/grounding/DECISIONS.md`
...
Write `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-226-linkaios-product-model-ui-foundation.md` with:
