# WP-204 Prompt — LiNKautowork Workflow Completion

Model: Kimi.

Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-204-linkautowork-workflow-completion.md`.
