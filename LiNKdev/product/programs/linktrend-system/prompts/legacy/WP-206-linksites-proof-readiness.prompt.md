# WP-206 Prompt — LinkSites Proof Readiness

Model: Composer.

Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-206-linksites-proof-readiness.md`.
