...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-231-linkskills-terminology-governance-ui.md` exactly.
...
1. `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-231-linkskills-terminology-governance-ui.md`
...
5. `LiNKdev/product/grounding/CONTRACTS_MVO.md` LinkSkills sections
...
Write `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-231-linkskills-terminology-governance-ui.md` with files changed, commands run, screenshots/proof, blockers, final commit SHA, and backlog items.
