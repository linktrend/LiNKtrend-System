...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-121-lexos-server-query-mutation-scaffold.md`.
...
- `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-121-lexos-server-query-mutation-scaffold.md`
...
Follow the work packet proof section. Update `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-121-lexos-server-query-mutation-scaffold.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
