...
Older packet prompts were moved to `LiNKdev/product/grounding/archive/legacy-work-packets-pre-architecture-cleanup/AGENT_PROMPTS/` because they contain pre-cleanup folder paths such as `plugins/vertical`, `LiNKbot/runtime-adapters/openclaw/bot-runtime`, and older product casing. They are historical evidence, not launch instructions.
