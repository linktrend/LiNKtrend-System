...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-232-uiux-integration-proof-and-review-readiness.md` exactly.
...
1. `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-232-uiux-integration-proof-and-review-readiness.md`
...
Capture screenshots under `LiNKdev/product/reports/archive/legacy-ai-swarm/artifacts/uiux-product-model/`.

## Required Report

Write `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-232-uiux-integration-proof-and-review-readiness.md` with:
