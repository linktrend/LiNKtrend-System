...
Execute `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-118-linkautowork-run-control-integration.md`.
...
- `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-118-linkautowork-run-control-integration.md`
...
Follow the work packet proof section. Update `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-118-linkautowork-run-control-integration.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
