...
- `.worktrees/WP-210-baseline-fix-and-build-gate/LiNKdev/product/reports/archive/legacy-ai-swarm/WP-210-baseline-fix-and-build-gate.md` if present
...
## Report File
Update `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-217-autowork-status-idempotency-visibility.md`.
