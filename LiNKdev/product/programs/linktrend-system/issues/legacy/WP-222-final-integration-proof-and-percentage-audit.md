...
- `LiNKdev/product/grounding/*COMPLETION*`, `LiNKdev/product/grounding/*PROOF*`, `LiNKdev/product/grounding/*RUNBOOK*`
...
- `LiNKdev/product/grounding/MASTER_PLAN.md`
- Worktree reports that may not exist in the main checkout:
  ...
  - `.worktrees/WP-215-linksites-linkbrain-trace-proof/LiNKdev/product/reports/archive/legacy-ai-swarm/WP-215-linksites-linkbrain-trace-proof.md`
...
## Report File
Update `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-222-final-integration-proof-and-percentage-audit.md`.
