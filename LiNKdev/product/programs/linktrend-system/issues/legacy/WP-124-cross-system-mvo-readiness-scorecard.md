...
- `LiNKdev/product/grounding/MVO_READINESS_SCORECARD.md`
- `LiNKdev/product/grounding/MVO_READINESS_SCORECARD.json`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-124-cross-system-mvo-readiness-scorecard.md`
...
- `LiNKdev/product/reports/archive/legacy-ai-swarm/*.md`
- `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-090*.md` through `WP-123*.md` as present
- `LiNKdev/product/grounding/END_OF_DAY_VERIFICATION_QUEUE.md`
