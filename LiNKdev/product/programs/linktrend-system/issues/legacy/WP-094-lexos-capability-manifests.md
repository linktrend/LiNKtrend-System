...
- `LiNKdev/product/programs/linktrend-system/issues/legacy/WP-094*.md`
...
- `LiNKdev/product/grounding/LEXOS_VERTICAL_PLUGIN_CONVERSION_PLAN.md` §3
- `LiNKdev/product/grounding/PLUGIN_ARCHITECTURE_V2.md`
- `LiNKdev/product/grounding/CONTRACTS_MVO.md` §0.A.5
