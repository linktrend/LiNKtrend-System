...
Older packet definitions were moved to `LiNKdev/archive/ai-swarm-embedded-archive/legacy-work-packets-pre-architecture-cleanup/WORK_PACKETS/` because many contain pre-cleanup paths and terminology. They are historical evidence, not current instructions.
