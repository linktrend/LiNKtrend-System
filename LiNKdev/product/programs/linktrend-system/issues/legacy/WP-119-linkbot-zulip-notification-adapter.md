...
- `LiNKdev/product/grounding/LINKBOT_ZULIP_NOTIFICATION_ADAPTER.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-119-linkbot-zulip-notification-adapter.md`
...
- `LiNKdev/product/grounding/CONTRACTS_MVO.md` capability sections for Zulip
