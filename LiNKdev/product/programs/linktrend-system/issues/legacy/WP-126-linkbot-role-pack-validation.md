...
- `LiNKdev/product/grounding/LINKBOT_ROLE_PACK_VALIDATION.md`
- `LiNKdev/product/reports/archive/legacy-ai-swarm/WP-126-linkbot-role-pack-validation.md`
...
- `LiNKdev/product/grounding/CONTRACTS_MVO.md` role sections
