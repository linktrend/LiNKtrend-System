...
From this point forward, the repo files under `LiNKdev/product/grounding/` are the operational source of truth.
...
- read `LiNKdev/product/grounding/ARCHITECTURE_RULES.md`
- read `LiNKdev/product/grounding/MASTER_PLAN.md`
- read `LiNKdev/product/grounding/CONTRACTS_MVO.md` if it exists
- read `LiNKdev/product/grounding/REPO_INVENTORY.md` if relevant
- read its assigned work packet
- update its report in `LiNKdev/product/reports/archive/legacy-ai-swarm/`
- produce proof before claiming completion
- stay within assigned scope
- avoid broad rewrites
- avoid adding dependencies without justification
- record significant decisions in `LiNKdev/product/grounding/DECISIONS.md`
...
Use `LiNKdev/product/grounding/` files as project memory. Do not rely on chat memory.
...
The `LiNKdev/product/grounding/` command center has been created.

Created folders:

- `LiNKdev/product/grounding/`
- `LiNKdev/product/programs/linktrend-system/issues/legacy/`
...
Keep `LiNKdev/product/grounding/` files current.
