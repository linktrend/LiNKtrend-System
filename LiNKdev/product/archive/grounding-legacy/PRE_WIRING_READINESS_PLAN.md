...
**When Principal says `execute pre-wiring readiness`:** Integrator runs waves 0→7 sequentially; parallel subagents within each wave; commit + push `development` after each wave.
...
**Prompt index:** `LiNKdev/product/programs/linktrend-system/prompts/legacy/PWR-*.prompt.md`  
**Launch copy-paste:** `LiNKdev/product/grounding/EXECUTE_PRE_WIRING.md`
...
**Acceptance:** `development` pushed; typecheck green; `LiNKdev/product/reports/archive/legacy-ai-swarm/PWR-W0-baseline.md` filed.
...
Integrator runs Wave 0→7 per `LiNKdev/product/grounding/EXECUTE_PRE_WIRING.md`.
...
| Wave | Report path |
|------|-------------|
| 0 | `LiNKdev/product/reports/archive/legacy-ai-swarm/PWR-W0-baseline.md` |
| 1 | `LiNKdev/product/reports/archive/legacy-ai-swarm/PWR-W1-A-*.md`, `PWR-W1-B-*.md` |
| 2 | `LiNKdev/product/reports/archive/legacy-ai-swarm/PWR-W2-*.md` |
| 3–6 | `LiNKdev/product/reports/archive/legacy-ai-swarm/PWR-W3-*.md` … `PWR-W6-*.md` |
| 7 | `LiNKdev/product/reports/archive/legacy-ai-swarm/PWR-W7-integrator-proof.md`, `PWR-FINAL.md` |
