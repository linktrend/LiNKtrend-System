...
Implement the context assembly service to provide LiNKbot with scoped, relevant historical context.
...
- `LiNKaios/linkaios-web/src/lib/kernel/context-assembler.ts`
