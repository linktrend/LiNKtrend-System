...
Execute `.ai-swarm/WORK_PACKETS/WP-211-module-workflow-map-gap-prep.md` exactly. This is a bounded module workflow-map prep packet.
...
- Update the required `.ai-swarm/AGENT_REPORTS/WP-211-module-workflow-map-gap-prep.md` before stopping.
