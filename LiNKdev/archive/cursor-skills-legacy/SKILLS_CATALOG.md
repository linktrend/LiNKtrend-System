...
canonical_dev_swarm_catalog: LiNKdev/skills/SKILLS_CATALOG.md
canonical_gstack_tree: LiNKdev/skills/gstack/
note: >-
  GStack skills are canonical under LiNKdev/skills/gstack/. Flat .cursor/skills/gstack-* entries are redirect stubs. For LiNKdev factory routing and merge policy, read LiNKdev/skills/SKILLS_CATALOG.md and MERGE-LOG.md.
skill_count: 153
mcp_server_count: 4
agent_instructions:
