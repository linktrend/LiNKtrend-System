...
Discover and scaffold the Zulip communication capability surface needed for LinkBots to communicate with each other and with the operator through LinkSkills-governed permissions.
...
- `apps/bot-runtime/**` only for narrow interface references, not runtime overhaul
- `.env.example`
