...
Execute `.ai-swarm/WORK_PACKETS/WP-218-linksites-proof-runbook-and-local-preview.md` exactly. This is a LinkSites runbook/local preview packet.
...
- Read `.worktrees/WP-212-linksites-runtime-spine/.ai-swarm/AGENT_REPORTS/WP-212-linksites-runtime-spine.md` if present. WP-212 reported that runtime proof was blocked by workspace topology resolving to legacy `apps/linkaios-web`; the runbook must not hide this blocker.
- Read `.ai-swarm/AGENT_REPORTS/WP-213-linksites-linkskills-enforcement.md`, `.ai-swarm/AGENT_REPORTS/WP-214-linksites-linkbot-role-execution.md`, and `.ai-swarm/AGENT_REPORTS/WP-215-linksites-linkbrain-trace-proof.md` if present.
...
- Update the required `.ai-swarm/AGENT_REPORTS/WP-218-linksites-proof-runbook-and-local-preview.md` before stopping.
