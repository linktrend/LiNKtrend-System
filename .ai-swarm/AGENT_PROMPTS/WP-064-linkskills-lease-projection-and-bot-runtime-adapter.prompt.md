...
Add a lease-governed LinkSkills adapter flow in `apps/bot-runtime` for skill and capability operations.
...
- Package-level test/typecheck for `apps/bot-runtime` if available.
