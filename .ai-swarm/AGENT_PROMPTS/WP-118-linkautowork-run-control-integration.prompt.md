...
Execute `.ai-swarm/WORK_PACKETS/WP-118-linkautowork-run-control-integration.md`.
...
- `.ai-swarm/WORK_PACKETS/WP-118-linkautowork-run-control-integration.md`
...
Follow the work packet proof section. Update `.ai-swarm/AGENT_REPORTS/WP-118-linkautowork-run-control-integration.md` with files changed, commands run, proof, blockers, branch, and commit SHA.
