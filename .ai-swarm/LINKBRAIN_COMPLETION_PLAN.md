...
- **Context Assembly:** LinkBots can request and receive a scoped, provenance-backed context bundle for any task.
...
- **Strategy:** Create a `benchmarks` table for anonymized metrics. Implement a "Feedback" capability for LinkBots/Operators.
