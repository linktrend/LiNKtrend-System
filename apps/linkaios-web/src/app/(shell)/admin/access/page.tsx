...
export default async function AdminAccessPage() {
  ...
  if (!allowed) {
    return (
      <main>
        <h1 className="text-xl font-semibold text-zinc-900">Access</h1>
  ...
  return (
    <main>
      <p className="text-sm text-zinc-500">
        ...
        <span className="text-zinc-900">Admin · access</span>
      </p>
      ...
      <p className="mt-2 max-w-3xl text-sm text-zinc-600">
        ...
        for normal writes, <code className="text-xs">admin</code> for this page. Removing a row restores implicit{" "}
        <strong>operator</strong> (same as before migration <code className="text-xs">010</code>), unless the account
        matches bootstrap admin emails.
      </p>
